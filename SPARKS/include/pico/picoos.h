...
void picoos_disposeCommon(picoos_MemoryManager mm, picoos_Common * instance);
...
void * picoos_allocate(picoos_MemoryManager instance, picoos_objsize_t byteSize);
void picoos_deallocate(picoos_MemoryManager instance, void * * adr);
...
void picoos_disposeExceptionManager(picoos_MemoryManager mm,
        picoos_ExceptionManager * instance);


void picoos_emReset(picoos_ExceptionManager instance);
 ...
 * the error! */
pico_status_t picoos_emRaiseException(picoos_ExceptionManager instance,
        pico_status_t exceptionCode, picoos_char * baseMessage, picoos_char * fmt, ...);

pico_status_t picoos_emGetExceptionCode(picoos_ExceptionManager instance);

void picoos_emGetExceptionMessage(picoos_ExceptionManager instance, picoos_char * msg, picoos_uint16 maxsize);

void picoos_emRaiseWarning(picoos_ExceptionManager instance,
        pico_status_t warningCode, picoos_char * baseMessage, picoos_char * fmt, ...);

picoos_uint8 picoos_emGetNumOfWarnings(picoos_ExceptionManager instance);

pico_status_t picoos_emGetWarningCode(picoos_ExceptionManager instance, picoos_uint8 warnNum);

void picoos_emGetWarningMessage(picoos_ExceptionManager instance, picoos_uint8 warnNum, picoos_char * msg, picoos_uint16 maxsize);
