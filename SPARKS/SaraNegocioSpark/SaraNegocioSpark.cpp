/*
 * SaraNegocioSpark.cpp
 *
 *  Created on: 07/02/2013
 *      Author: guille
 */

/// @file SaraNegocioSpark.cpp
/// @brief SaraNegocioSpark class implementation.


//#include "stdAfx.h"
#include "SaraNegocioSpark.h"
...
{
	if (!strcmp(componentType, "SaraNegocioSpark")) {
			return new SaraNegocioSpark(componentInstanceName, componentSystem);
		}
	else {
			return NULL;
		}
...
/// Initializes SaraNegocioSpark component.
void SaraNegocioSpark::init(void){
	try
	{
		/*
		...
		cout << endl << endl;
		cout << "[SaraNegocio now fully loaded]" << endl;
...
/// Unitializes the SaraNegocioSpark component.
void SaraNegocioSpark::quit(void){
}

void SaraNegocioSpark::processData(char *prompt){
