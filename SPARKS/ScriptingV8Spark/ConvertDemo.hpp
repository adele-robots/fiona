...
typedef cvv8::Signature<BoundNative (
    cvv8::CtorForwarder<BoundNative *()>,
    cvv8::CtorForwarder<BoundNative *(int)>
)> BoundNativeCtors;
/**
...
struct BoundSubNative : public BoundNative
{
    ...
    {
        return cvv8::StringBuffer() << "[object BoundSubNative@"<<(void const *)this<<"]";
    }
