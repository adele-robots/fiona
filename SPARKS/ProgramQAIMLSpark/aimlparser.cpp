...
#include <iostream>
AIMLParser::AIMLParser(bool displayTree, const QString& currentPath) : displayTree(displayTree),currentPath(currentPath)
{
    indent = 0;
    root.parent = NULL;
    ...
    //Create the log file
    QFile *file = new QFile("ProgramQDebug.log", this);
