...
<fwn:OutputPanel id="panelWrapperPaypal">
	<fwn:Form id="signupAgreementForm" 
		...
		<fwn:OutputPanel id="panelTextoPaypal" layout="block">
			...
			<fwn:OutputPanel layout="block" style="text-align: center;">
				<fwn:OutputText id="errorPaypal" rendered="#{!empty(treelogic.errorPaypalSEC)}" style="color:red; padding-bottom:50px;" value="#{msg['FIONA.store.integratorBuyer.setexpresscheckout.error.valor']}"></fwn:OutputText>			
	...
	<fwn:OutputPanel layout="block" styleClass="separador" style="margin-top:20px; text-align:center;">
		<fwn:AjaxButton ajaxonclicklistener="SetExpressCheckoutStoreListener" styleClass="paypalECButton" value="" style="float:none; font-size:16pt; margin:0 10px;" 
		...
		<fwn:Button id="backButton" action="back" styleClass="fio-back-button" immediate="true" value="" rendered="#{!empty(treelogic.errorPaypalSEC)}"></fwn:Button>
