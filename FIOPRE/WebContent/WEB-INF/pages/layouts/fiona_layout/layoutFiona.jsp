...
<head>
	...
	<script type="text/javascript" language="javascript" src="${request.contextPath}/js/jquery.jplist.3.4.js"></script>
	<script type="text/javascript" language="javascript" src="${request.contextPath}/js/autoadvance.js"></script>
	<script type="text/javascript" language="javascript" src="${request.contextPath}/js/slideshow.js"></script>
	<script type="text/javascript" language="javascript" src="${request.contextPath}/js/moreOrLess.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="${request.contextPath}/css/paginacion/paginacion.css" />
