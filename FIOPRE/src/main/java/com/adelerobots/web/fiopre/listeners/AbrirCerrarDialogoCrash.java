...
public class AbrirCerrarDialogoCrash extends AbstractUserProcessListener {
	...
	public void procesarAjaxChangeListener(GestorEstadoComponentes gestorEstados,
		...
		if(strCodSpark != null){
			...
			try {
				Object datoComplejo = invokeGetListCrash(intCodSpark);
				
				List<Map<String, String>> datosStatus = (List<Map<String, String>>) datoComplejo;
				
				gestorDatos.setValue("tablaCrash", datosStatus);
				
				gestorEstados.openModalAlert("dialogoListCrash");
