...
/**
 * Clase encargada de iniciar el flujo de restore password.
 * @author adele
 */
public class PasswordRestoreInitSetupCustomAction implements ICustomAction {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 5060162972643880743L;
		...
		throws PresentacionException 
	{
		...
		helper.setValueContext("PASSWORDRESTORE_BACK_MODE", mode, IHelperCustom.FLUJO_CTX_TYPE);
