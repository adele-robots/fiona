...
public class DesasignaKeywordsListener implements IProcesadorDeAjaxChangeListener {
	...
	private static final String FIELD_KEYWORDS_SELECCIONADAS = "keys_asignados";
	private static final String FIELD_ALL_KEYWORDS = "all_keywords";
	...
	public void procesarAjaxChangeListener(GestorEstadoComponentes gestorEstados,
		...
		Map allKeywords = gestorDatos.getItems(FIELD_ALL_KEYWORDS);
