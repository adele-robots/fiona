...
<title>New change of status!</title>
<style type="text/css">
#outlook a{
padding:0;
}
...
<div style="color: #505050;font-family: Arial;font-size: 12px;line-height: 100%;text-align: left;">An spark changed its status!<br/>
</div>
</td>
<!-- *|IFNOT:ARCHIVE_PAGE|* -->
...
<br/>&nbsp;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-family: Arial, Helvetica;font-size: 130%;font-weight: bolder;">One user changed an spark status, <span style="color:#ED1479;">${user.fullname}</span></strong>
<br/><br/>
<span style="font-family:trebuchet ms,helvetica,sans-serif;">
&nbsp;&nbsp;&nbsp;&nbsp;A new change of status was made by <strong style="color:#ED1479;">${user.email}</strong>.
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp; The user <strong style="color:#ED1479;"> ${user.fullname}</strong> changed the spark <strong style="color:#ED1479;">${sparkName}</strong> to the new status <strong style="color:#ED1479;">
${newStatus}</strong>.
