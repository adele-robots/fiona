...
<br/>&nbsp;<br/>
&nbsp;&nbsp;&nbsp;&nbsp; This is the receipt of ${fecha} for your virtual robots of The Client Relations Factory for (${usuario.email}) that will be charged in your paypal account. 
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp; <h4>Virtual Robots</h4>
