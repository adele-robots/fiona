...
table#priceTable th{ border-bottom: 2px solid #505050; }
table#priceTable tfoot {border-top: 2px solid #505050;}
table#priceTable td.numero {text-align:right;}
...
<br/>&nbsp;<br/>
&nbsp;&nbsp;&nbsp;&nbsp; These are the sparks you have developed that are being used by others in FIONA development environment.
You will get the payment via Paypal in the next few days.

<br/><br/>
<table id="priceTable" cellpadding="10">
	<tr>
		<th>Name</th>
	...
	[#list lstSparksPrecios as spark]
		<tr>
			<td>${spark.nombreSpark}</td>
			<td class="numero">${spark.precioSparkUnitario}</td>
			<td class="numero">${spark.cantidad}</td>
			<td class="numero">${spark.precioSparkSinDescuento}</td>
			<td class="numero">${spark.comision}</td>
			<td class="numero">${spark.precioSpark}</td>
		</tr>
	[/#list]
	<tfoot>
	    <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;We would like to remind you that you can have a lower fee if you upgrade your account.
