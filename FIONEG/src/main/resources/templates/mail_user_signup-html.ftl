...
&nbsp;
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;Thanks for joining Fiona! 
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;We need to confirm your email, so please, click on the following link: <a href="http://${ConfigUtils.getSERVER_IP()}/FIOPRE/adele/useremail-confirm-flow?u=${(user.cnUsuario?c)?default("")?url('UTF-8')}&t=${(user.signupCode)?default("")?url('UTF-8')}" target="_blank">confirm email</a>.
<br/><br/>
