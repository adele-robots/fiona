...
<title>I want invite you to FIONA!</title></head>
<style type="text/css">
#outlook a{
padding:0;
}
...
<div style="color: #505050;font-family: Arial;font-size: 12px;line-height: 100%;text-align: left;">You've been invited!<br/>
</div>
</td>
<!-- *|IFNOT:ARCHIVE_PAGE|* -->
...
<br/>&nbsp;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-family: Arial, Helvetica;font-size: 130%;font-weight: bolder;">New invitation has been requested
<br/><br/>

<strong>FIONA user:</strong> ${(user.fullname)?default("")} [#if (user.email)?default("")?has_content](${(user.email)?default("")})[/#if]
<br/>
<strong>Guest name:</strong> ${(guestName)?default("")}
<br/>
<strong>Guest email:</strong> ${(guestEmail)?default("")}
<br/>
[#if (message)?default("")?has_content]
<strong>User message:</strong> ${(message)?default("")}
<br/>
[/#if]
<strong>Invitation text:</strong> I would like to invite you to FIONA, at <a href="http://www.sparkingtogether.com" target="_blank">www.sparkingtogether.com</a>.
<br/>
<br/>
</span></div>
