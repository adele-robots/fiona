...
<div style="color: #505050;font-family: Arial;font-size: 12px;line-height: 100%;text-align: left;">New incoming account cancellation!<br/>
</div>
</td>
<!-- *|IFNOT:ARCHIVE_PAGE|* -->
...
<br/>&nbsp;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-family: Arial, Helvetica;font-size: 130%;font-weight: bolder;">New account cancellation, <span style="color:#ED1479;">${(user.fullname)?default("")}</span></strong>
<br/><br/>
<span style="font-family:trebuchet ms,helvetica,sans-serif;">
&nbsp;&nbsp;&nbsp;&nbsp;A new account cancellation was made by <strong style="color:#ED1479;">${(user.email)?default("")}</strong>.
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;Thanks,
<br/>
</span></div>
