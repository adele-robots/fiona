...
<div style="color: #505050;font-family: Arial;font-size: 12px;line-height: 100%;text-align: left;">Thanks for registering!<br/>
</div>
</td>
<!-- *|IFNOT:ARCHIVE_PAGE|* -->
...
<span style="font-family:trebuchet ms,helvetica,sans-serif;">&nbsp;&nbsp;&nbsp;&nbsp;Hi[#if (user.fullname)??] <strong>${(user.fullname)?default("")}</strong>[/#if],
<br/>
&nbsp;
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;Thanks for joining Fiona! We are still taking the first steps and we'll give you access to the community when the beta version is launched! 
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;In first place, we need to confirm your email, so please, click on the following link: <a href="http://${ConfigUtils.getSERVER_IP()}/FIOPRE/adele/useremail-confirm-flow?u=${(user.cnUsuario?c)?default("")?url('UTF-8')}&t=${(user.signupCode)?default("")?url('UTF-8')}" target="_blank">confirm email</a>.
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp; We'll keep you informed about the progress, but if you have any questions, please send us an email to 
<a href="mailto:${(ConfigUtils.getMAIL_NOTIFICATION_ADDR())?default("fiona@sparkingtogether.com")}" target="_blank">${(ConfigUtils.getMAIL_NOTIFICATION_ADDR())?default("fiona@sparkingtogether.com")}</a> 
and we will be glad to answer you.
<br/><br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;Spread the word!
<br/>
</span></div>
...
<strong>FIONA&#39;s team</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<br/>
</div>
</td>
</tr>
...
<a href="https://twitter.com/Sparking2gether" target="_blank" style="color: #336699;font-weight: normal;text-decoration: underline;">follow on Twitter</a>
 &nbsp;|&nbsp; 
<a href="https://www.facebook.com/pages/Sparking-Together/180513272042574" target="_blank" style="color: #336699;font-weight: normal;text-decoration: underline;">follow on Facebook</a>
 &nbsp;|&nbsp; 
<a href="http://www.adelerobots.com/en/" target="_blank" style="color: #336699;font-weight: normal;text-decoration: underline;">About us</a><br/>
</div>
</td>
</tr>
<tr>
