...
<span style="font-family:trebuchet ms,helvetica,sans-serif;">&nbsp;&nbsp;&nbsp;&nbsp;Hi Fiona Team!,
<br/>&nbsp;<br/>


&nbsp;&nbsp;&nbsp;&nbsp; The user[#if (usuario.fullname)??] <strong>${(usuario.fullname)?default("")}</strong>[/#if], with id <strong>${usuario.cnUsuario}</strong> has no billingID
or has canceled the billing agreement. We have sent an email advising him/her to check this on Paypal, but meanwhile, we should check the bbdd to make sure that
billingAgreementId is not null!!!
