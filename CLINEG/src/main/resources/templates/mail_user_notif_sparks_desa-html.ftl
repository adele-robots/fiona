...
<br/>&nbsp;<br/>
&nbsp;&nbsp;&nbsp;&nbsp; These are the sparks you are using now and also, the sparks we will charge in your paypal account. 
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp; <h4>Sparks List</h4>
<ul id="listaSparks" style="list-style-type:none;">
[#list lstSparksPrecios as spark]
  &nbsp;&nbsp;&nbsp;&nbsp;<li> <div id="nombre" style="float:left;"><strong style="font-family: Arial, Helvetica;font-size: 130%;font-weight: bolder;">${spark.nombreSpark} (${spark.periodicidad})</strong></div>  <div id="precio" style="float:right;">${spark.precioSpark} USD</div></li> 
[/#list]
...
<br/>
<br/>
<span style="font-family:trebuchet ms,helvetica,sans-serif;">To avoid your sparks renovation, you just have to uninstall those sparks you won't use anymore.</span>
<br/>
<br/>
</div>
</td>
