...
<div style="color: #505050;font-family: Arial;font-size: 12px;line-height: 100%;text-align: left;">New incoming signup!<br/>
</div>
</td>
<!-- *|IFNOT:ARCHIVE_PAGE|* -->
...
<br/>&nbsp;<br/>
&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-family: Arial, Helvetica;font-size: 130%;font-weight: bolder;">New account registration, <span style="color:#ED1479;">${(user.fullname)?default("")}</span></strong>
<br/><br/>
<span style="font-family:trebuchet ms,helvetica,sans-serif;">
&nbsp;&nbsp;&nbsp;&nbsp;A new registration was made by <strong style="color:#ED1479;">${(user.email)?default("")}</strong>.
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;To complete this registration, click on the following link: <a href="http://${ConfigUtils.getSERVER_IP()}/FIOPRE/adele/signup-confirm-flow?u=${(user.cnUsuario?c)?default("")?url('UTF-8')}&t=${(user.signupCode)?default("")?url('UTF-8')}" target="_blank">confirm signup</a>.
When done, remember <a href="mailto:${(user.email)?default("")}?subject=${'[FIONA] Signup confirmed by staff'?url('UTF-8')}" target="_blank">send her/him an email</a> to notify that already can gain access to the platform.
<br/><br/>
&nbsp;&nbsp;&nbsp;&nbsp;Thanks,
<br/>
</span></div>
